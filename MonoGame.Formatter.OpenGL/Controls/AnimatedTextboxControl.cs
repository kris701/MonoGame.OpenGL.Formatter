...
using MonoGame.Formatter.OpenGL.Controls.Elements;
using MonoGame.Formatter.OpenGL.Textures;

namespace MonoGame.Formatter.OpenGL.Controls
{
	/// <summary>
	/// A version of the <seealso cref="TextboxControl"/> that has an animated tile control behind it.
	/// </summary>
