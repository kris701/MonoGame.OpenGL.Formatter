...
namespace MonoGame.Formatter.OpenGL.Input
{
	/// <summary>
	/// An input watcher that listens for a set of keys
	/// </summary>
	public class KeysAllWatcher
	{
		/// <summary>
		...
		public KeysAllWatcher(List<Keys> keys, Action? pressAction = null, Action? unpresAction = null)
		{
			Keys = keys;
